...
@Repository("MMSQL")
public class CiudadRepoImplMMSQL implements ICiudadRepoCustom{
	...
	public List<CiudadEntity> BuscarByName(String name) {
		...
		Query q = entityManager.createNativeQuery("SELECT * FROM ciudad WHERE ciu_nom LIKE '%" + name + "%'", CiudadEntity.class);
